...
CREATE TABLE "ConversationMember" (
    "id" TEXT NOT NULL,
    "hasReadlastMessage" BOOLEAN NOT NULL,
    "unreadMessageNumber" INTEGER NOT NULL,
    "userId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_latestMessageId_fkey" FOREIGN KEY ("latestMessageId") REFERENCES "Message"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

...
export type AddNewMembersMutation = { __typename?: 'Mutation', addNewMembers: { __typename?: 'MessageReturn', message: string } };
...
export type RemoveMembersMutation = { __typename?: 'Mutation', removeMembers: { __typename?: 'MessageReturn', message: string } };
...
export type GetConversationsMembersQueryVariables = Exact<{
  conversationId: Scalars['String']['input'];
}>;


export type GetConversationsMembersQuery = { __typename?: 'Query', getConversationsMembers: Array<{ __typename?: 'FoundUsers', id: string, username?: string | null, image?: string | null }> };
...
export type MessageSentSubscription = { __typename?: 'Subscription', messageSent: { __typename?: 'MessageSentReturn', message: { __typename?: 'Message', id: string, body: string, type: MessageType, isDeleted?: boolean | null, conversationId: string, createdAt: any, updatedAt: any, sender: { __typename?: 'User', id: string, email?: string | null, username?: string | null, name?: string | null, image?: string | null } }, members?: Array<{ __typename?: 'ConversationMembers', id: string, hasReadlastMessage: boolean, unreadMessageNumber: number, user: { __typename?: 'User', id: string, email?: string | null, username?: string | null, name?: string | null, image?: string | null } }> | null } };
...
export type FindUsersNotInChatQueryVariables = Exact<{
  username: Scalars['String']['input'];
  conversationId: Scalars['String']['input'];
}>;


export type FindUsersNotInChatQuery = { __typename?: 'Query', findUsersNotInChat: Array<{ __typename?: 'FoundUsers', id: string, username?: string | null, image?: string | null }> };
...
export const GetConversationsMembersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getConversationsMembers"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getConversationsMembers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"conversationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]}}]} as unknown as DocumentNode<GetConversationsMembersQuery, GetConversationsMembersQueryVariables>;
...
export const FindUsersNotInChatDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"findUsersNotInChat"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"username"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"findUsersNotInChat"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"username"},"value":{"kind":"Variable","name":{"kind":"Name","value":"username"}}},{"kind":"Argument","name":{"kind":"Name","value":"conversationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]}}]} as unknown as DocumentNode<FindUsersNotInChatQuery, FindUsersNotInChatQueryVariables>;